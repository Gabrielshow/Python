#Automated testing of transpositionEncrypt, transpositionDecrypt

import random, sys, transpositionencryption, transpositiondecryption
...
def main():
    ...
    for i in range (20): # Run 20 tests.
        ...
        for key in range (1, int(len(message)/2)):
            encrypted = transpositionencryption.encryptMessage(key, message)
